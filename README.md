...
:-: | :-: | :-  | :-:   
:triangular_flag_on_post: | **AAAI** | Cross-Layer and Cross-Sample Feature Optimization Network for Few-Shot Fine-Grained Image Classification | Paper/Code
:triangular_flag_on_post: | **TMM** | Robust Saliency-Aware Distillation for Few-shot Fine-grained Visual Recognition | [Paper](https://ieeexplore.ieee.org/document/10445009)/Code    
:scroll: | **PR** | Re-abstraction and perturbing support pair network for few-shot fine-grained image classification | [Paper](https://www.sciencedirect.com/science/article/pii/S0031320323008555)/Code    
